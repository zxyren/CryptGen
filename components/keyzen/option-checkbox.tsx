...
export function OptionCheckbox({ label, checked, onChangeAction, disabled }: Props) {
  return (
    ...
    >
      <span
        className={`flex size-6 shrink-0 items-center justify-center rounded-md border transition-all duration-200 ${
          checked
      ...
      >
        <Check
          className={`size-4 text-white transition-all duration-200 ${
